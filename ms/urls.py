...
from tm.views import MaterialListView, materialStorage,GradeListView,allocMaterial, MaterialEntryListView,MaterialOutBoundListView,MaterialInventoryListView
...
urlpatterns = [
    ...
    ##path(r'materialStorage/detail/', listMaterial),
    ...
    path(r'materialInfo/',MaterialInventoryListView.as_view(), name = 'inventoryMaterial_list'),
