...
urlpatterns = [
    ...
    path(r'materialRecord/entry/', MaterialEntryListView.as_view(),
         name='materialstoragemodel_list'),
    path(r'materialRecord/out/', MaterialOutBoundListView.as_view(),
         name='materialallocmodel_list')
